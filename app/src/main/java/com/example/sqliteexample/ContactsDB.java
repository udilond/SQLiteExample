...
public class ContactsDB {
    ...
    private class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            /*
            We want to create a table as follows:
        ...
        public String getData(){
            ...
            int indexCell = cursor.getColumnIndex(KEY_CELL);


            for(cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()){

                result = result + cursor.getString(indexRowID) + ": " + cursor.getString(indexName) + " " +
                        cursor.getString(indexCell) + "\n";
            }
        ...
        public long updateEntry(String rowID, String name, String cell){
            ...
            return ourDatabase.update(DATABASE_TABLE, contentValues, KEY_ROWID + "=?",
                    new String[] {rowID});
        }
